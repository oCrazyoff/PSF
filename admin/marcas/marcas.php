    ...
    <div class="content">
        <table>
            <div class="titulo">
                ...
                <a href="cadastro_marca.php">Nova Marca <i class="fa-solid fa-circle-plus"></i></a>
            </div>
            <thead>
                <tr>
                    <th>Marca</th>
            ...
            <tbody>
                <?php
                $sql = "SELECT * FROM marcas ORDER BY status DESC";
                ...
                while ($row = $resultado->fetch_assoc()) {
                    ...
                    <tr>
                        ...
                        <td>
                            <form class='action' action='edita_marca.php' method='post'>
