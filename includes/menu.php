<div class="sidebar">
    <ul class="sidebar-menu">
        ...
        <ul>
            <li><a href="../admin/pessoas_fisica.php"><i class="fa-solid fa-user"></i>Pessoas Físicas</a></li>
            <li><a href="../admin/pessoas_juridica.php"><i class="fa-solid fa-user"></i>Pessoas Juridícas</a></li>
        </ul>
